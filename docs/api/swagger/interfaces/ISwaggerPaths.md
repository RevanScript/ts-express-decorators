...
meta:
 - name: keywords
   description: api typescript node.js documentation ISwaggerPaths interface
---
# ISwaggerPaths <Badge text="Interface" type="interface"/>
<!-- Summary -->
<section class="symbol-info"><table class="is-full-width"><tbody><tr><th>Module</th><td><div class="lang-typescript"><span class="token keyword">import</span> { ISwaggerPaths }&nbsp;<span class="token keyword">from</span>&nbsp;<span class="token string">"@tsed/swagger"</span></div></td></tr><tr><th>Source</th><td><a href="https://github.com/TypedProject/ts-express-decorators/blob/v5.2.5/packages/swagger/src/interfaces/ISwaggerPaths.ts#L0-L0">/packages/swagger/src/interfaces/ISwaggerPaths.ts</a></td></tr></tbody></table></section>
