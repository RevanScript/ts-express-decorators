...
---
# getConstructor <Badge text="Function" type="function"/>
<!-- Summary -->
...
<pre><code class="typescript-lang "><span class="token keyword">const</span> getConstructor<span class="token punctuation">:</span> <span class="token punctuation">(</span>targetClass<span class="token punctuation">:</span> <span class="token keyword">any</span><span class="token punctuation">)</span> =&gt<span class="token punctuation">;</span> Function<span class="token punctuation">;</span></code></pre>
